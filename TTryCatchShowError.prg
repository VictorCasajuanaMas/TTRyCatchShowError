...
/* METHDO: Show( cString )
    Muestra el error en pantalla añadiendo el string cString al principio.

    Parámetros:
        cString - Cadena que se añadirá como primer línea
*/
...
METHOD ToString() CLASS TTryCatchShowerror
    ...
    try 
        ...
        If ::oError:Operation:NotEmpty()
            ...
            cError += 'Operación: '+ ::oError:Operation:Str() + hb_eol()
